            ...
            if not has_read_all_events:
                ...
                if len(list_words) > 1:
                    if list_words[1] == "Metric":  # check end events
                        ...
                        front_end_value_has_found = self._front_end.set_event_value(
                ...
                if (
                    ...
                    frond_end_description_has_found = (
                        self._front_end.set_metric_description(
                    ...
                    back_end_description_has_found = (
                        self._back_end.set_metric_description(
                            metric_name, metric_description
                        )
                    )
                    ...
                    divergence_description_has_found = (
                        self._divergence.set_metric_description(
                            metric_name, metric_description
                        )
                    )
                    extra_measure_value_has_found = (
                        self._extra_measure.set_metric_value(
                            metric_name, metric_avg_value
                        )
                    )
                    extra_measure_description_has_found = (
                        self._extra_measure.set_metric_description(
                            metric_name, metric_description
                        )
                    )
                    ...
                    retire_description_has_found = self._retire.set_metric_description(
                        metric_name, metric_description
                    )
                    if not (
                        front_end_value_has_found
                        ...
                        frond_end_description_has_found
                        or back_end_description_has_found
                        or divergence_description_has_found
                        or extra_measure_description_has_found
