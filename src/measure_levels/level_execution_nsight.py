...
class LevelExecutionNsight(LevelExecution, ABC):
    ...
    def _add_result_part_to_lst(self, dict_values: dict, dict_desc: dict, lst_to_add):
        """
        ...
        metrics_events_not_average: list = (
    ...
    def _percentage_time_kernel(self, kernel_number: int) -> float:
        ...
        value_lst: list = self._extra_measure.get_metric_value(
            LevelExecutionParameters.C_CYCLES_ELAPSED_METRIC_NAME_NSIGHT
        )
