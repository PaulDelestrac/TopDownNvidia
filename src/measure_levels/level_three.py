...
class LevelThree(LevelTwo):
    ...
    def memory_constant_memory_bound_stall_on_back(self) -> float:
        ...
        return (
            (self.memory_constant_memory_bound_stall() / super().back_end_stall())
            * 100.0
            if super().back_end_stall()
            else 0
        )
    ...
    def memory_constant_memory_bound_stall_on_memory_bound(self) -> float:
        ...
        return (
            (
                self.memory_constant_memory_bound_stall()
                / super().back_memory_bound_stall()
            )
            * 100.0
            if super().back_memory_bound_stall()
            else 0
        )
        pass
    ...
    def memory_constant_memory_bound_percentage_ipc_degradation(self) -> float:
        ...
        return (
            (
                (
                    self._stall_ipc()
                    * (self.memory_constant_memory_bound_stall() / 100.0)
                )
