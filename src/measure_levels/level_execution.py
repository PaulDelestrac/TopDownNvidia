...
class LevelExecution(ABC):
    ...
    def __init__(
        ...
        shell: Shell = Shell()
        compute_capability_str: str = shell.launch_command_show_all(
    ...
    def _launch(self, command: str) -> str:
        ...
        shell: Shell = Shell()
        output_command: str = shell.launch_command_redirect(
            command,
            LevelExecutionParameters.C_INFO_MESSAGE_EXECUTION,
    ...
    def get_device_max_ipc(self) -> float:
        ...
        dict_warps_schedulers_per_cc: dict = dict(
            {
                3.0: 4,
                3.2: 4,
                3.5: 4,
        ...
        return dict_warps_schedulers_per_cc.get(
            self._compute_capability
        ) * dict_ins_per_cycle.get(self._compute_capability)
